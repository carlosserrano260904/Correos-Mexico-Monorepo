...
export class OficinaTipoVehiculoDto {
  ...
  @ApiProperty({ example: ['Automóvil 400 kg', 'Camionetas de pasajeros tipo VAN'], type: [String] })
  tiposVehiculo: string[];

  @ApiProperty({ required: false, example: 'Esta oficina no tiene tipos de vehículo asignados' })
  mensaje?: string;
}
