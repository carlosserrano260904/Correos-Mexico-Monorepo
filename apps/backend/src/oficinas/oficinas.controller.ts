...
export class OficinasController {
  ...
  @Get('codigo-postal-zona/:clave_oficina_postal')
  findCodigoPostalZona(@Param('clave_oficina_postal') clave: number) {
    return this.oficinasService.findCodigoPostalZona(clave);
  }
