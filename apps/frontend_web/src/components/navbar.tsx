                        ...
                        {!user ? (
                            ...
                            <div className="flex-col">
                                ...
                                <div className="flex flex-col space-y-2 sm:space-y-3">
                                    ...
                                    <Link href="/historial-de-compras" onClick={handleDropdownClose} className="text-gray-700 hover:text-gray-900 font-medium text-sm sm:text-base flex items-center gap-2 transition-colors">
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
