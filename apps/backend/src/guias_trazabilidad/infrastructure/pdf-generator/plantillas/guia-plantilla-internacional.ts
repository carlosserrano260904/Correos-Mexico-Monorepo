...
export const plantillaGuiaInternacional = async (guiaData: GuiaPdfPayload, qrCodeDataURL: string) => {
  ...
  const renderField = (label: string, value: string | number) => {
    return createElement(View, { style: styles.fieldRow },
  ...
  return createElement(Document, {},
    createElement(Page, { size: 'A4', style: styles.page },
      ...
      // numero de rastreo
      createElement(View, { style: styles.trackingSection },
        createElement(Text, { style: styles.trackingNumber }, guiaData.numeroRastreo)
      ),
      ...
      createElement(View, { style: styles.mainContent },
        ...
        createElement(View, { style: styles.packageInfoContainer },
          createElement(View, { style: styles.packageInfoBox },
            createElement(Text, { style: styles.packageInfoTitle }, 'VALOR DECLARADO'),
            createElement(Text, { style: styles.packageInfoValue }, `$${guiaData.valorDeclarado}`)
          ),
          createElement(View, { style: styles.packageInfoBox },
            createElement(Text, { style: styles.packageInfoTitle }, 'PESO (KG)'),
            createElement(Text, { style: styles.packageInfoValue }, guiaData.embalaje.peso)
          ),
          createElement(View, { style: styles.packageInfoBox },
            createElement(Text, { style: styles.packageInfoTitle }, 'DIMENSIONES (CM)'),
            createElement(Text, { style: styles.packageInfoValue },
        ...
        createElement(View, { style: styles.twoColumnContainer },
          ...
          createElement(View, { style: styles.rightColumn },
            ...
            renderField('Nombre', `${guiaData.destinatario.nombres} ${guiaData.destinatario.apellidos}`),
        ...
        createElement(View, { style: styles.fullWidthSection },
          ...
          createElement(View, { style: styles.checkboxSection },
            createElement(View, { style: styles.checkboxItem },
          ...
          createElement(View, { style: styles.checkboxSection },
            ...
            createElement(View, { style: styles.checkboxItem },
              createElement(View, { style: styles.checkbox }),
              createElement(Text, { style: styles.checkboxLabel }, 'Cert. Origen')
            ),
            createElement(View, { style: styles.checkboxItem },
              createElement(View, { style: styles.checkbox }),
          ...
          createElement(View, { style: { marginTop: 4 } },
            ...
            createElement(Text, { style: { fontSize: 6, marginTop: 1 } }, 'Forma de Pago: _____________ Seguro: _______ No. Factura: _____________ Valor: $ _______')
          )
        ),

        // envio
        createElement(View, { style: styles.deliverySection },
          createElement(Text, { style: styles.sectionTitle }, 'DATOS DEL ENVÍO - ACCEPTANCE'),
          createElement(View, { style: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 } },
          ...
          createElement(View, { style: styles.signatureBox },
            createElement(Text, { style: styles.signatureLabel }, 'Mensajero(a) Clave y Firma')
          )
        ),

        // informacion del envio
        createElement(View, { style: styles.deliverySection },
          createElement(Text, { style: styles.sectionTitle }, 'ENTREGA - DELIVERY'),
          createElement(View, { style: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 } },
            createElement(Text, { style: { fontSize: 6 } }, 'Fecha recibo: _________'),
            createElement(Text, { style: { fontSize: 6 } }, '1er Aviso: _________'),
            createElement(Text, { style: { fontSize: 6 } }, '2do Aviso: _________')
          ),
          createElement(Text, { style: { fontSize: 6, marginBottom: 3 } }, 'Fecha y Hora Entrega: _________________________'),
          createElement(View, { style: { flexDirection: 'row', justifyContent: 'space-between' } },
            createElement(View, { style: { flex: 1, marginRight: 2 } },
              createElement(View, { style: styles.signatureBox },
                createElement(Text, { style: styles.signatureLabel }, 'Nombre y firma destinatario')
              )
            ),
            createElement(View, { style: { flex: 1, marginLeft: 2 } },
              createElement(View, { style: styles.signatureBox },
                createElement(Text, { style: styles.signatureLabel }, 'Mensajero clave y firma')
              )
            )
          )
        ),
        ...
        // retorno
        createElement(View, { style: styles.returnSection },
          createElement(Text, { style: styles.sectionTitle }, 'CAUSAS DE DEVOLUCIÓN'),
          createElement(View, { style: styles.checkboxSection },
            createElement(View, { style: styles.checkboxItem },
              createElement(View, { style: styles.checkbox }),
              createElement(Text, { style: styles.checkboxLabel }, 'Dir. Incorrecta')
            ),
            createElement(View, { style: styles.checkboxItem },
              createElement(View, { style: styles.checkbox }),
              createElement(Text, { style: styles.checkboxLabel }, 'Desconocido')
            ),
            createElement(View, { style: styles.checkboxItem },
              createElement(View, { style: styles.checkbox }),
            ...
            createElement(View, { style: styles.checkboxItem },
              createElement(View, { style: styles.checkbox }),
              createElement(Text, { style: styles.checkboxLabel }, 'No Localizado')
            )
          ),
          createElement(Text, { style: { fontSize: 6, marginTop: 2 } }, 'Observaciones: ___________________________________')
        ),

        // qr
        createElement(View, { style: styles.qrSection },
          createElement(View, { style: styles.qrLeft },
            createElement(Text, { style: styles.instructionsTitle }, 'INSTRUCCIONES'),
            createElement(Text, { style: styles.instructionsText },
              'Para entrega se requiere:\n' +
              '• ID oficial vigente • Firma de recibido\n' +
              '• Verificación de datos del destinatario'
            )
          ),
          createElement(View, { style: styles.qrRight },
            createElement(Image, {
              style: styles.qrCode,
              src: qrCodeDataURL
            }),
