...
export class PedidosController {
  ...
  @ApiResponse({ status: 200, description: 'Lista de pedidos', type: [PedidoResponseDto] })
  findAll() {
  ...
  */
  ...
  @ApiParam({ name: 'id', type: Number, description: 'ID del usuario (profileId)' })
  @ApiResponse({ status: 200, description: 'Lista de pedidos del usuario', type: [PedidoResponseDto] })
