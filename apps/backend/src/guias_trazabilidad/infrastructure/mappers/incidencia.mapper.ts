...
export class IncidenciaMapper {
    // domain -> orm
    static toOrm(incidenciaEntity: IncidenciaDomainEntity, idGuia: string): IncidenciasTypeormEntity {
        ...
        incidenciaOrm.tipo_incidencia = incidenciaEntity.tipoIncidencia.getIncidencia
    ...
    static toDomain(incidenciaOrm: IncidenciasTypeormEntity) {
        return IncidenciaDomainEntity.fromPersistence({
            ...
            tipoIncidencia: TipoIncidenciaVO.fromPersistence(incidenciaOrm.tipo_incidencia),
