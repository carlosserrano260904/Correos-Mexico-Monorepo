...
const BecomeSeller: React.FC = () => {
  ...
  const handleComenzarSolicitud = () => {
    // Revisar si ya hay una solicitud guardada en este navegador
    ...
    // Si no hay solicitud previa, mandar al formulario
    router.push("/registro_vendedor");
  };
  ...
  return (
    <Plantilla>
      <div className="relative overflow-hidden bg-white">
        ...
        {/* Triángulos decorativos SVG */}
        <svg
          className="absolute top-10 left-0 w-32 h-32 opacity-40 fill-pink-300 rotate-12 z-0"
          viewBox="0 0 100 100"
        >
          <polygon points="0,0 100,0 50,100" />
        </svg>
        <svg
          className="absolute top-1/2 right-0 w-24 h-24 opacity-40 fill-pink-300 rotate-45 z-0"
          viewBox="0 0 100 100"
        >
          <polygon points="0,0 100,0 50,100" />
        </svg>
        <svg
          className="absolute bottom-10 left-10 w-28 h-28 opacity-40 fill-pink-300 -rotate-12 z-0"
          viewBox="0 0 100 100"
        >
          <polygon points="0,0 100,0 50,100" />
        </svg>
